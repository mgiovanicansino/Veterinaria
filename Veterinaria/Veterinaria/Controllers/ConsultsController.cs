...
namespace Veterinaria.Controllers
{
    public class ConsultsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ConsultDay,Descripction,ConsultType")] Consult consult)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ConsultDay,Descripction,ConsultType")] Consult consult)
        {
            if (ModelState.IsValid)
            {
